...
def greet():
    conn = sqlite3.connect('Swaadhin.db')#Heisenberg.db
    ...
    conn.commit()
    conn.close()
    SR.speak("\nMyself Swaadhin. Special Assistant for Special people. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Swaadhin and I'm here to serve you.")
            #How are you
            elif there_exists(['how are you'],query):
                conn = sqlite3.connect('Swaadhin.db')
                mycursor=conn.cursor()
            ...
            #playing on youtube
            elif there_exists(['open youtube and search','on youtube','youtube'],query):
                if 'on youtube' or 'youtube' in query:
                    ...
                    SR.speak("Opening youtube")
                    pywhatkit.playonyt(query.replace('open youtube and search',''))
            ...
            #     break
            elif there_exists(['search on google','open google and search','google and search','open google and'],query):
            ...
            elif there_exists(['who is','who the heck is','who the hell is','who is this','what is'],query):
                query=query.replace("wikipedia","")
            ...
            #play music
                ...
                webbrowser.open("https://wynk.in/music/song/alone/sm_A10328E0008101697J")
                break
            #open prototype
            elif there_exists(['prototype','open prototype','open our website','open swadhin','swadhin website'],query):
                SR.speak("Opening prototype")
                webbrowser.open("https://swaadhin.vercel.app")
                break
            #open our website
            elif there_exists(['mentor','open mentorius','mentors','mentorius'],query):
                SR.speak("Opening mentorius")
                webbrowser.open("https://mentorius.netlify.app/")
                break
            ...
            #whatsapp message
                ...
                del whatsapp
            #what is meant by
            elif there_exists(['what is meant by','what is mean by','meaning of'],query):
                results=wikipedia.summary(query,sentences=2)
                SR.speak("According to wikipedia:\n")
                SR.speak(results)

            #taking photo
            elif there_exists(['click a picture','camera','take a pic','take a selfie','take my photo','take photo','take selfie','one photo please','click a photo'],query):
            ...
            #makig note
            elif there_exists(['write a note','make a note','take note','take a note','note it down','make note','remember this as note','open notepad and write'],query):
            ...
            #opening software applications
                ...
                break
            #presentation
            elif there_exists(['open our presentation','ppt','swadhin ppt','swaadhin ppt','open ppt'],query):
                SR.speak('opening presentation')
                os.startfile(r'V:\\Swaadhin\\swaadhin.ppsm')
                break
                ...
                os.startfile('C:\Program Files\WindowsApps\Microsoft.Paint_11.2308.18.0_x64__8wekyb3d8bbwe\PaintApp\mspaint.exe')
                break
                ...
                os.startfile("C:\Program Files\WindowsApps\Microsoft.ScreenSketch_11.2309.11.0_x64__8wekyb3d8bbwe\SnippingTool\SnippingTool.exe")
                break
            elif there_exists(['open code','open visual studio ','open vs code'],query):
                SR.speak("Opening vs code")
                codepath=r"C:\Users\91738\AppData\Local\Programs\Microsoft VS Code\Code.exe"
...
if __name__=="__main__":
        ...
        root.set_theme("winnative")                                #- 745/2
        root.geometry("{}x{}+{}+{}".format(1100,400,int(root.winfo_screenwidth()/2- 1100/2),int(root.winfo_screenheight()/2 - 400/2)))
        root.resizable(0,0)
        root.title("Swaadhin")
        root.iconbitmap('Swaadhin.ico')
        root.configure(bg='#2c4557')                           #disabled                                #fa8b2a,#add8e6    #0a0a09 #800000
        scrollable_text=scrolledtext.ScrolledText(root,state='disabled',height=15,width=87,relief='sunken',bd=5,wrap=tk.WORD,bg='#101820',fg='#FFF700')
        ...
        Speak_label.place(x=560,y=300)#x=250,y=300
        """Setting up objects"""
        ...
        Listen_Button.place(x=500,y=280)#x=330 y=280
        myMenu=tk.Menu(root)
