...
class TextSpeech:
    ...
    def opentxt(self):
        ...
        try:                                                       #C:\Users\Vishal\Documents\Projects
            file_path=filedialog.askopenfilename(initialdir =r"V:\Swaadhin\Swaadhin AI Bot or \Notes",title="Select file",filetypes=(('text file',"*.txt"),("All files", "*.*")))
...
class SettingWindow:
    ...
    def settingWindow(self,root):
        ...
        self.volume=ttk.Label(self.setting,text="Swaadhin's Volume: ",borderwidth=0,font=('"Times New Roman"')).place(x=3,y=17)
